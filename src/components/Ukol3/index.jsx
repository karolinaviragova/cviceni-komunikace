  ...
  return (
    <>
      ...
      <div className="products">
        <Product image="/clothing/item01.jpg" name="Bunda" price={500} onSelectPrice={handlePrice}/>
        <Product image="/clothing/item02.jpg" name="Halenka" price={1200} onSelectPrice={handlePrice}/>
        <Product image="/clothing/item03.jpg" name="Svetr" price={1500} onSelectPrice={handlePrice}/>
        <Product image="/clothing/item04.jpg" name="Mikina" price={800} onSelectPrice={handlePrice}/>
      </div>
    </>
  );
};
